"""Executable near/far impact assurance for Code Nav Intent Gate."""
from dataclasses import asdict,dataclass
from math import isfinite
from typing import Iterable
REPOSITORY="sourcegraph-code-nav-intent-gate"; COMPANY_LENS="Sourcegraph"; INNOVATION="Code Nav Intent Gate"
